...
const Navbar = () => {
    ...
    return (
        <nav className="w-full  lg:px-20 px-4 py-4 fixed top-0 left-0 z-40 bg-[#1A1A19] border-b-0">
            <div className="flex justify-between items-center">
                ...
                <div className="hidden sm:space-x-1 md:space-x-4 items-center sm:flex">
                    <Link className="hidden md:block" href="https://github.com/shazab-saifi/WireSketch.git" aria-label="GitHub repository">
                        <GithubIcon />
                    </Link>
                    <Button 
