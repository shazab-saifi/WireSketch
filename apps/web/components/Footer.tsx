...
const Footer = () => {
  return (
    <div className='mx-4 bg-[#212121] flex flex-col items-center lg:items-start justify-between space-y-16 py-8 lg:py-12 mt-20 rounded-t-3xl lg:flex-row lg:px-24'>
      <div className="flex flex-col items-center space-y-16 lg:items-start lg:space-x-8">
        <Image src={Logo} alt="Logo" />
        <Image src={SocialIcons} alt="Socials links" />
      </div>
